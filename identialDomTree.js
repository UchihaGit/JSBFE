/* rootA & B is a DOM tree, similar to below. here node.children gives use all the children properties of that node.
node.parentNode returns a parent node if it exists. 
* recursive is straight forward
* iteration uses BFS 
* node.parentNode is used to find the path of the target node using loops. then in rootB with the created path traverse
and return.
* DFC and other not viewed yet.
*/
/*
* Test Case
